...
view1HeaderExtension = "/objc/IntegrationApp/VIAFirstView.h"

view1MExtension :: String
view1MExtension =  "/objc/IntegrationApp/VIAFirstView.m"

view2HeaderExtension :: String
view2HeaderExtension = "/objc/IntegrationApp/VIASecondView.h"

view2MExtension :: String
view2MExtension = "/objc/IntegrationApp/VIASecondView.m"

view3HeaderExtension :: String
view3HeaderExtension = "/objc/IntegrationApp/VIAThirdView.h"

view3MExtension :: String
view3MExtension = "/objc/IntegrationApp/VIAThirdView.m"

view1HeaderTestExtension :: String
view1HeaderTestExtension = "/objc/IntegrationApp/VIAFirstView.h.test"

view1MTestExtension :: String
view1MTestExtension =  "/objc/IntegrationApp/VIAFirstView.m.test"

view2HeaderTestExtension :: String
view2HeaderTestExtension = "/objc/IntegrationApp/VIASecondView.h.test"

view2MTestExtension :: String
view2MTestExtension = "/objc/IntegrationApp/VIASecondView.m.test"

view3HeaderTestExtension :: String
view3HeaderTestExtension = "/objc/IntegrationApp/VIAThirdView.h.test"

view3MTestExtension :: String
view3MTestExtension = "/objc/IntegrationApp/VIAThirdView.m.test"
